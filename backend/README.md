...
## Project Structure
    ...
    ├── test_app_nutrition_38110  # Django project configurations
...
1. Clone this repo and `cd test_app_nutrition_38110`
...
2. Clone this repo and `cd test_app_nutrition_38110`
